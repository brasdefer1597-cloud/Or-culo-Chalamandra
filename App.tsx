            ...
            <div className="space-y-8">
              <div className="text-center space-y-4 mb-12 animate-fade-in">
                <div className="flex justify-center items-end gap-4 md:gap-8 mb-6">
                  {/* LCP hero image — eager loaded, explicit dimensions to prevent layout shift */}
                  <div className="relative flex-shrink-0">
                    <div className="absolute inset-0 bg-chala-green/20 blur-2xl scale-110 rounded-full"></div>
                    <picture>
                      <source srcSet="/brand-street-wisdom.webp" type="image/webp" />
                      <img
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    <picture>
                      <source srcSet="/chalamandra.webp" type="image/webp" />
                      <img
                        src="/chalamandra.png"
